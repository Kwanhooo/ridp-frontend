...
import {checkParameters, formatTime} from "@/app/utils/util";
import {
  Select,
  SelectContent,
  SelectItem,
...
const Page = () => {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('h3').forEach((item) => {
      item.setAttribute('style', 'font-size: 18px !important;');
    });
  ...
  return (
    <div className="flex flex-col h-screen" id="bigScreenGov">
      {loading && (
